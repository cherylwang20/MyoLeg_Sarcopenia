...
for env_name in dof_env:
	...
	model = PPO.load('standingBalance/policy_best_model/myoLegReachFixed-v2/2023_11_08_17_21_38/best_model',  env, ent_coef= 0.01, verbose=0, policy_kwargs=policy_kwargs, tensorboard_log="./standingBalance/temp_env_tensorboard/"+env_name)
