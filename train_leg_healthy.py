...
for env_name in dof_env:
    ...
    project="cherylwang20/MyoLeg-Training",
	...
	if sarco:
		model = PPO.load(f'standingBalance/policy_best_model/myoLegReachFixed-v2/2023_11_22_17_43_32/best_model',  env, ent_coef= 0.01, verbose=0, policy_kwargs=policy_kwargs, tensorboard_log="./standingBalance-sarco/temp_env_tensorboard/"+env_name)
	else:
